...
if (!empty($_POST)) {
    ...
    if ($valid) {
        ...
        $sql = "INSERT INTO paints (paintName,paintSize,paintFinish,paintCode) values(?, ?, ?, ?)";
        $q = $pdo->prepare($sql);
...
<body>
    <div class="container">
        <div class="span10 offset1">
            ...
            <form class="form-horizontal" action="createPaint.php" method="post">
                <div class="control-group <?php echo !empty($nameError) ? 'error' : ''; ?>">
                    <label class="control-label">Paint Name:</label>
                    <div class="controls">
                        <input name="paintName" type="text" placeholder="Paint Name"
                ...
                <div class="control-group <?php echo !empty($sizeError) ? 'error' : ''; ?>">
                    ...
                    <div class="controls">
                        <input name="paintSize" type="text" placeholder="Size" value="<?php echo !empty($size) ? $size : ''; ?>">
                ...
                <div class="control-group <?php echo !empty($codeError) ? 'error' : ''; ?>">
                    ...
                    <div class="controls">
                        <input name="paintCode" type="text" placeholder="Code" value="<?php echo !empty($code) ? $code : ''; ?>">
